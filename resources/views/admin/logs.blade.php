    ...
    <div class="card mb-4">
        <div class="card-body-custom">
            <form method="GET" class="d-flex gap-2">
                <input type="text" name="search" class="form-control-custom flex-fill"
                    placeholder="Search action, details, or user..." value="{{ $search }}">
                ...
                <tbody>
                    @forelse($logs as $i => $log)
                        ...
                        <tr>
                            ...
                            <td>{!! $log->user ? \App\Helpers\SscHelper::roleBadge($log->user->role) : '<span class="text-muted">—</span>' !!}
                            </td>
