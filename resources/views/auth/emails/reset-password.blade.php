                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 20px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.03); border: 1px solid #e2e8f0;">
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            <h2 style="margin-top: 0; color: #0f172a; font-size: 20px; font-weight: 700; letter-spacing: -0.2px;">Reset your portal password</h2>
                            <p style="font-size: 15px; line-height: 1.6; color: #475569;">Hello,</p>
                            <p style="font-size: 15px; line-height: 1.6; color: #475569;">We received a request to reset the password for your account on the **Madridejos Community College Supreme Student Council Portal**. Please use this 6-digit password reset verification code to proceed:</p>
                            
                            <!-- OTP Box -->
                            <div style="text-align: center; margin: 32px 0;">
                                <div style="display: inline-block; background-color: #fef3c7; border: 2px dashed #d97706; color: #d97706; letter-spacing: 6px; padding: 18px 40px; border-radius: 16px; font-size: 32px; font-weight: 800; font-family: monospace;">{{ $otp }}</div>
                            </div>

                            <p style="font-size: 14px; line-height: 1.6; color: #64748b; margin-bottom: 24px;">This verification code is valid for **15 minutes**. If you did not initiate this request, you can safely ignore this email — your password will remain unchanged.</p>
