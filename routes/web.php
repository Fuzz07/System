...
Route::group([], function () use ($baseDomain) {
    ...
    Route::prefix('m/student')->name('mobile.student.')->middleware(['auth', 'role:student'])->group(function () {
        ...
        Route::post('/enrollment', function (\Illuminate\Http\Request $request) {
            ...
            return redirect()->route('mobile.student.enrollment')->with('success', 'Payment record created! Please send ' . $methodLabel . ' and upload proof. Reference: ' . $payment->reference);
