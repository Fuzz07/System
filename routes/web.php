...
use App\Http\Controllers\Treasurer;
use App\Http\Controllers\Dean;
...
Route::domain('admin.' . $baseDomain)->group(function () use ($baseDomain) {
    ...
    Route::middleware(['auth', 'role:admin'])->name('admin.')->group(function () {
        ...
        Route::post('/settings/maintenance/request-otp', [Admin\SettingsController::class, 'requestMaintenanceOtp'])->name('settings.maintenance.request_otp');
        Route::post('/settings/maintenance/toggle', [Admin\SettingsController::class, 'toggleMaintenance'])->name('settings.maintenance.toggle');
        ...
        Route::delete('/settings/logout-device/{sessionId}', [Admin\SettingsController::class, 'logoutDevice'])->name('settings.logout_device');
...
// ─── Officer Subdomain Routing ───
Route::domain('officer.' . $baseDomain)->group(function () {
    Route::get('/', function () {
...
// ─── Dean Subdomain Routing ───
Route::domain('dean.' . $baseDomain)->group(function () {
    Route::get('/', function () {
...
// ─── Treasurer Subdomain Routing ───
Route::domain('treasurer.' . $baseDomain)->group(function () {
    Route::get('/', function () {
